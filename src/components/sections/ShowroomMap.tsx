    ...
    <div className="relative aspect-[16/9] overflow-hidden border border-hairline bg-panel">
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 flex items-end justify-between gap-4 bg-gradient-to-t from-[rgba(13,13,15,0.9)] to-transparent p-5">
        ...
        <a
          ...
          className="p1-mono pointer-events-auto inline-flex min-h-11 items-center whitespace-nowrap border border-hairline bg-ink px-3 text-ash transition-[border-color,color] duration-[120ms] ease-signal hover:border-signal hover:text-signal"
        >
          Directions →
        </a>
      </div>
